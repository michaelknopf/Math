...
makeTree = function(where2,where3){
  ...
  prp(fit,uniform=T,fallen.leaves=T,type=2, yesno=T,extra = 2,
      box.col = c(adjustcolor('blue',0.7),adjustcolor('red',0.7))[fit$frame$yval], branch.col='black')
  return(fit)
}
...
# where2 = c(1,2,7,13,18,3)
# where3 = c(1,8,30,24,37,34,10)
...
### the most consistently successful k-value is 5.
